...
# Player
playerImg = pygame.transform.scale(pygame.image.load('18.02.2026/player.png'), (48, 48))
...
for _i in range(num_of_enemies):
    enemyImg.append(pygame.transform.scale(pygame.image.load('18.02.2026/UFO.jpg'), (48, 48)))
    enemyX.append(random.randint(0, SCREEN_WIDTH - 48))  # 48 is the new size of the enemy
    enemyY.append(random.randint(ENEMY_START_Y_MIN, ENEMY_START_Y_MAX))
    enemyX_change.append(ENEMY_SPEED_X)
    enemyY_change.append(ENEMY_SPEED_Y)

# Bullet
bulletImg = pygame.transform.scale(pygame.image.load('18.02.2026/bullet.png'), (20, 40))
bulletX = 0
...
while running:
    ...
    playerX = max(0, min(playerX, SCREEN_WIDTH - 48))  # 48 is the new size of the player
